...
_C.SOLVER = CN()
_C.SOLVER.MAX_ITER = 31250
_C.SOLVER.STOP_ITER = 10000

_C.SOLVER.LR_METHOD = 'poly'
_C.SOLVER.BASE_LR = 0.00006
_C.SOLVER.BASE_LR_D = 0.0001
...
# This is global, so if we have 4 GPUs and BATCH_SIZE = 8, each GPU will
